 ...
 */
final class Version20241111102323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admin (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE admin_global_permissions (id INT AUTO_INCREMENT NOT NULL, admin_id INT DEFAULT NULL, role_id INT DEFAULT NULL, INDEX IDX_8FBB31C0642B8210 (admin_id), INDEX IDX_8FBB31C0D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE admin_global_permissions ADD CONSTRAINT FK_8FBB31C0642B8210 FOREIGN KEY (admin_id) REFERENCES admin (id)');
        $this->addSql('ALTER TABLE admin_global_permissions ADD CONSTRAINT FK_8FBB31C0D60322AC FOREIGN KEY (role_id) REFERENCES admin_role (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin_global_permissions DROP FOREIGN KEY FK_8FBB31C0642B8210');
        $this->addSql('ALTER TABLE admin_global_permissions DROP FOREIGN KEY FK_8FBB31C0D60322AC');
        ...
        $this->addSql('DROP TABLE admin_global_permissions');
